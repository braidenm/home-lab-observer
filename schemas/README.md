...
`v1/` contains JSON Schema 2020-12 contracts for capabilities, the current sanitized local snapshot, and RFC 9457-style
Problem Details. `v1/fixtures/manifest.json` declares which synthetic fixtures must pass and which must fail.
