...
try {
    ...
    if ($exitCode -ne 0) {
        $allowedStages = @(
            ...
            'system-before-time-value',
            'system-before-level-read',
            'system-before-level-value',
            'system-before-event-id-read',
            'system-before-event-id-value',
            'system-before-provider-guid-read',
            'system-before-provider-guid-value',
            'system-before-record-id-type',
            'system-before-record-id-value',
            'system-before-bookmark-read',
            'system-before-bookmark-precall-reject',
            'system-before-bookmark-create-start',
            'system-before-bookmark-create-error',
            'system-before-bookmark-create-invalid',
            'system-before-bookmark-create-ok',
            'system-before-bookmark-update-start',
            'system-before-bookmark-update-error',
            'system-before-bookmark-update-ok',
            'system-before-bookmark-native-render-start',
            'system-before-bookmark-native-render-error',
            'system-before-bookmark-native-render-ok',
            'system-before-bookmark-render-start',
            'system-before-bookmark-render-error',
            'system-before-bookmark-render-ok',
            'system-before-bookmark-result-error',
            'system-before-bookmark-result-ok',
            'system-before-bookmark-decode',
            'system-before-anchor-record-id',
            'system-before-anchor-time',
            'system-before-anchor-event-id',
            'system-before-anchor-provider-guid',
            'system-before-anchor-flags',
            'system-before-forward-eof',
            'application-before-query-open',
            'application-before-next',
            'application-before-time-read',
            'application-before-time-value',
            'application-before-level-read',
            'application-before-level-value',
            'application-before-event-id-read',
            'application-before-event-id-value',
            'application-before-provider-guid-read',
            'application-before-provider-guid-value',
            'application-before-record-id-type',
            'application-before-record-id-value',
            'application-before-bookmark-read',
            'application-before-bookmark-precall-reject',
            'application-before-bookmark-create-start',
            'application-before-bookmark-create-error',
            'application-before-bookmark-create-invalid',
            'application-before-bookmark-create-ok',
            'application-before-bookmark-update-start',
            'application-before-bookmark-update-error',
            'application-before-bookmark-update-ok',
            'application-before-bookmark-native-render-start',
            'application-before-bookmark-native-render-error',
            'application-before-bookmark-native-render-ok',
            'application-before-bookmark-render-start',
            'application-before-bookmark-render-error',
            'application-before-bookmark-render-ok',
            'application-before-bookmark-result-error',
            'application-before-bookmark-result-ok',
            'application-before-bookmark-decode',
            'application-before-anchor-record-id',
            'application-before-anchor-time',
            'application-before-anchor-event-id',
            'application-before-anchor-provider-guid',
            'application-before-anchor-flags',
            'application-before-forward-eof',
            'application-after-query-open',
            'application-after-next',
            'application-after-time-read',
            'application-after-time-value',
            'application-after-level-read',
            'application-after-level-value',
            'application-after-event-id-read',
            'application-after-event-id-value',
            'application-after-provider-guid-read',
            'application-after-provider-guid-value',
            'application-after-record-id-type',
            'application-after-record-id-value',
            'application-after-bookmark-read',
            'application-after-bookmark-precall-reject',
            'application-after-bookmark-create-start',
            'application-after-bookmark-create-error',
            'application-after-bookmark-create-invalid',
            'application-after-bookmark-create-ok',
            'application-after-bookmark-update-start',
            'application-after-bookmark-update-error',
            'application-after-bookmark-update-ok',
            'application-after-bookmark-native-render-start',
            'application-after-bookmark-native-render-error',
            'application-after-bookmark-native-render-ok',
            'application-after-bookmark-render-start',
            'application-after-bookmark-render-error',
            'application-after-bookmark-render-ok',
            'application-after-bookmark-result-error',
            'application-after-bookmark-result-ok',
            'application-after-bookmark-decode',
            'application-after-anchor-record-id',
            'application-after-anchor-time',
            'application-after-anchor-event-id',
            'application-after-anchor-provider-guid',
            'application-after-anchor-flags',
            'application-after-forward-eof',
            ...
            'application-after-native-next-error',
            'application-after-native-next-eof',
            'application-after-native-next-invalid',
            'application-after-native-next-record',
            'application-after-render-start',
            'application-after-render-error',
            'application-after-render-ok',
            'system-reverse-tail',
