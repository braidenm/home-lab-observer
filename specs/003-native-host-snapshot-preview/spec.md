...
- **R5 Portability:** The runtime MUST test on GitHub-hosted Windows, macOS, and Linux and cross-build Linux, Windows, and macOS binaries with pinned actions in less than 15 minutes.
...
lock the Go result to that fixture, and runtime CI exercises native test jobs plus no-CGO cross-builds.
