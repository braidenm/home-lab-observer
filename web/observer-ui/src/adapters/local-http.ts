...
/**
 * Reads only the two accepted Spec 002 endpoints. Payloads are projected into
 * the closed UI model; no log summary or arbitrary structured fields are derived.
 */
