...
export const syntheticWorkloads: WorkloadSnapshot = {
  ...
  items: [
    { kind: "process", id: "p-1842", processId: 1842, name: "postgres", state: "running", cpuPercent: 12.8, memoryBytes: 1_442_840_576, startedAt: isoBefore(16_420) },
    { kind: "process", id: "p-2941", processId: 2941, name: "platform-demo", state: "running", cpuPercent: 8.1, memoryBytes: 986_710_016, startedAt: isoBefore(3_220) },
    { kind: "process", id: "p-702", processId: 702, name: "dockerd", state: "running", cpuPercent: 3.6, memoryBytes: 422_576_128, startedAt: isoBefore(16_430) },
    { kind: "process", id: "p-3110", processId: 3110, name: "node", state: "sleeping", cpuPercent: 1.2, memoryBytes: 271_581_184, startedAt: isoBefore(970) },
